...
const CONFIG_CURSO = {
    ...
    totalModulos: 8,
    moduloAprobacion: 6, // Módulo de evaluación
...
function inicializarCurso() {
    ...
    // Si estamos en un módulo específico, marcarlo como visitado
...
function navegarAModulo(numeroModulo) {
    ...
    if (numeroModulo >= 0 && numeroModulo < carpetas.length) {
        // Marcar módulo actual como completado antes de navegar
        marcarModuloCompleto(moduloActual);
        
        // Navegar al nuevo módulo
...
function calcularEvaluacion() {
    ...
    // Verificar que se respondieron todas
    ...
    if (resultadoDiv) {
        ...
        if (aprobado) {
            ...
            // Guardar aprobación en localStorage
